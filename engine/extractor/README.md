...
1. Download the extractor script:
   ```bash
   wget https://raw.githubusercontent.com/yourorg/ws-psidwh/main/engine/extractor/synapse_dmv_extractor.py
   ```
...
Next Steps:
  Run lineage parser: python engine/main.py run --parquet parquet_snapshots
======================================================================
```
...
- script: |
    python engine/extractor/synapse_dmv_extractor.py \
