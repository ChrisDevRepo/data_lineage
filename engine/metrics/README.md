...
1. **CLI** (`engine/main.py`)
   - Shows SP-only metrics during parse
   - Explicit scope: "Stored Procedure"

2. **JSON Summary** (`engine/output/summary_formatter.py`)
...
- **Implementation:** `engine/metrics/metrics_service.py`
- **Usage in CLI:** `engine/main.py` (lines 353-367)
- **Usage in JSON:** `engine/output/summary_formatter.py` (lines 178-225)
