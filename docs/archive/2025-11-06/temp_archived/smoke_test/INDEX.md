...
**Status:** ✅ Tests passing (issue resolved 2025-11-04)
...
- Parser version history (v4.0.3 → v4.1.2)
...
### test_dataflow_mode.py (6.5KB) ⭐ MAIN TEST
...
```
Status: ✅ SUCCESS: Dataflow mode working correctly
```
...
```json
{
  ...
  "passed": false,
  "message": "❌ FAILED: GLCognosData appears in inputs",
  "details": {
    "glc_in_inputs": true,  ← WRONG!
    "glc_in_outputs": true
  }
}
```
...
**Finding:** Confirms 0 SELECT patterns with GLCognosData ✅
...
**Impact:**
- ✅ Dataflow mode now working correctly
- ✅ Eliminates false positives for ALL DML operations
- ✅ Clean lineage graphs for all stored procedures
