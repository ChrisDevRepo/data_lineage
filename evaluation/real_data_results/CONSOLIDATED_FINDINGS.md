...
python evaluation/view_evaluation.py --create-baseline
```
...
**Analysis Scripts:**
- ✅ `evaluation/simple_real_data_analysis.py` - Basic parser evaluation
- ✅ `evaluation/real_data_analysis.py` - Full parser evaluation (ready to use)
- ✅ `evaluation/smoke_test_analysis.py` - Plausibility testing

**Results:**
- ✅ `evaluation/real_data_results/parser_results.json` - 349 SP results
- ✅ `evaluation/real_data_results/smoke_test_results.json` - Plausibility data
...
- ✅ `evaluation/real_data_results/REAL_DATA_ANALYSIS_FINDINGS.md` - Detailed findings
- ✅ `evaluation/real_data_results/SUMMARY_FOR_USER.md` - Executive summary
- ✅ `evaluation/real_data_results/CONSOLIDATED_FINDINGS.md` - **THIS FILE**
