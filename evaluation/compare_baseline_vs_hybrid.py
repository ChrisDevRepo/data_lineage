...
comp_df.to_json('evaluation/baseline_vs_hybrid_comparison.json', orient='records', indent=2)
print(f"✓ Detailed comparison saved to evaluation/baseline_vs_hybrid_comparison.json")
