...
3. **✅ Smoke Test Created**
   ...
   - Tool: `evaluation/smoke_test_analysis.py`
...
**Analysis Scripts:**
- `evaluation/simple_real_data_analysis.py` - Basic parser eval (used for analysis)
- `evaluation/real_data_analysis.py` - Full parser eval (ready for future use)
- `evaluation/smoke_test_analysis.py` - **NEW** - Plausibility testing

**Results:**
- `evaluation/real_data_results/parser_results.json` - 349 SP detailed results
- `evaluation/real_data_results/smoke_test_results.json` - **NEW** - Plausibility data
- `evaluation/real_data_results/sqlglot_analysis.json` - Failure patterns
- `evaluation/real_data_results/CONSOLIDATED_FINDINGS.md` - **NEW** - All findings merged
- `evaluation/real_data_results/SUMMARY_FOR_USER.md` - Executive summary
...
**How to Use:**
1. Run smoke test: `python evaluation/smoke_test_analysis.py`
2. Look at results: `evaluation/real_data_results/smoke_test_results.json`
...
**Evaluation Tools:**
- Basic eval: `evaluation/simple_real_data_analysis.py`
- Full eval: `evaluation/real_data_analysis.py`
- Smoke test: `evaluation/smoke_test_analysis.py`
...
- Consolidated findings: `evaluation/real_data_results/CONSOLIDATED_FINDINGS.md`
