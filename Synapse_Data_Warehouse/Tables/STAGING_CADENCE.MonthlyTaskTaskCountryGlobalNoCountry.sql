CREATE TABLE [STAGING_CADENCE].[MonthlyTaskTaskCountryGlobalNoCountry]
(
	...
	[Total SUM Task Approved Total Units] [decimal](19,4) NULL,
...
WITH
(
	DISTRIBUTION = HASH ( [Period Year],[Period Month],[Project Name] ),
