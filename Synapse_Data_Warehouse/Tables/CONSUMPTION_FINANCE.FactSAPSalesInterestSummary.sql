CREATE TABLE [CONSUMPTION_FINANCE].[FactSAPSalesInterestSummary]
(
	[FactSAPSalesInterestSummaryKey] [int] IDENTITY(1,1) NOT NULL,
...
WITH
(
	DISTRIBUTION = HASH ( [DimCustomerKey],[CostType] ),
