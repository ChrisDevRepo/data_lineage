                    ...
                    <main className="flex-grow p-4 overflow-y-auto">
                        <div className="max-w-2xl mx-auto space-y-4">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <h3 className="font-semibold text-blue-900 mb-2">Upload Parquet Files</h3>
                                <p className="text-sm text-blue-800 mb-2">
                                    Select all Parquet files from the PySpark DMV extractor. The system will automatically detect and validate the file types.
                                </p>
                                <p className="text-xs text-blue-700">
                                    <strong>Required:</strong> objects, dependencies, definitions | <strong>Optional:</strong> query_logs, table_columns
                                </p>
                            </div>
