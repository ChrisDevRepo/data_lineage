                                ...
                                <div className="flex items-start gap-4 p-4 rounded-lg bg-gray-50">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm text-gray-600 leading-relaxed space-y-2">
                                            <p>
                                                <strong>Parsing Process:</strong> The application extracts data lineage from stored procedures using <strong>pure YAML regex patterns</strong>. Pattern matching identifies table references (FROM/JOIN, INSERT/UPDATE, EXEC, SELECT INTO), followed by post-processing to clean brackets, parse schema.table names, and handle aliases. The metadata catalog validates results, filtering out false positives.
                                            </p>
                                            <p>
                                                <strong>YAML Rule Engine:</strong> Business-maintainable <strong>YAML extraction rules</strong> define the patterns for finding dependencies. Cleaning rules standardize SQL formatting, while extraction rules identify source and target tables. Power users can extend support to new databases by creating custom YAML rules without writing Python code.
                                            </p>
