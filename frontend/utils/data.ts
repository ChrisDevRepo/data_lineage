...
// Cache for sample data to avoid regenerating on every call
let cachedSampleData: DataNode[] | null = null;
...
export const generateSampleData = (): DataNode[] => {
    ...
    // Cache the generated data for subsequent calls
    cachedSampleData = nodes;
    return nodes;
};
