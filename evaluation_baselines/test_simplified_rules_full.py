...
# Save results
results_df.to_json('evaluation_baselines/simplified_rules_comparison.json', orient='records', indent=2)
print(f"\n✓ Results saved to evaluation_baselines/simplified_rules_comparison.json")
