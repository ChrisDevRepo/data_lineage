...
results_df.to_json('evaluation_baselines/best_effort_parsing_results.json', orient='records', indent=2)
print(f"\n✓ Detailed results saved to evaluation_baselines/best_effort_parsing_results.json")
...
import json
with open('evaluation_baselines/baseline_vs_hybrid_comparison.json') as f:
