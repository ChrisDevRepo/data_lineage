...
**Where to keep it:**
- Testing/validation scripts (`evaluation_baselines/`)
- Debugging tools
...
**New location:** `evaluation_baselines/validation_utils.py`
...
**Existing scripts in `evaluation_baselines/`:**
...
**New file:** `evaluation_baselines/validation_utils.py`
...
- `evaluation_baselines/smoke_test.py` - Use validation_utils for comparison
...
4. Keep regex tests in `evaluation_baselines/` for validation
