...
results_df.to_json('evaluation_baselines/warn_vs_strict_comparison.json', orient='records', indent=2)
print(f"\n✓ Detailed results saved to evaluation_baselines/warn_vs_strict_comparison.json")
